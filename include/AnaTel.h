...
class AnaTel {
  ...
  public:
    ...
    Double_t GetRhat(Int_t Ipl, Bool_t UseInFit);

    gbl::GblTrajectory BuildTscope(Int_t Ipl, Bool_t UseInFit);

    gbl::GblPoint getPoint(double step, double res, TVectorD wscat, bool IsPlane, bool has_meas = false);
